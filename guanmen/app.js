...
const els = {
  ...
  safeLayer: document.querySelector('#safe-layer'), blockedLayer: document.querySelector('#blocked-layer'), twilightLayer: document.querySelector('#twilight-layer'), labels: document.querySelector('#timeline-labels'), ticks: document.querySelector('#axis-ticks'), markers: document.querySelector('#sun-markers'), callouts: document.querySelector('#time-callouts'), list: document.querySelector('#window-list'), ship: document.querySelector('#ship-marker')
};
